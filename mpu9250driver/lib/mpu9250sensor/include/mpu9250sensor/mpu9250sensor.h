...
class MPU9250Sensor {
 ...
 private:
  ...
  double mag_adj_x_ = {1.0};
  double mag_adj_y_ = {1.0};
  double mag_adj_z_ = {1.0};
  ...
  static constexpr int ASAX = 0x10;
  static constexpr int ASAY = 0x11;
  static constexpr int ASAZ = 0x12;
